...
Class Produtos extends Conexao{
	 ...
	 private $pro_nome, $pro_categoria, $pro_ativo, $pro_cli, $pro_cli_nome,
	...
	private function GetLista(){
		...
		$this->itens[$i] = array(
             ...
             'pro_cli_nome' => $lista['pro_cli_nome'],   
	...
	function Preparar($pro_nome, $pro_categoria, $pro_ativo, $pro_cli, $pro_cli_nome, 
        $pro_valor, $pro_img, $pro_desc){
        ...
        $this->setPro_cli_nome($_SESSION['CLI']['cli_nome']);
    ...
    function Inserir(){
        ...
        $query.= " pro_cli_nome, pro_valor, pro_img, pro_desc)"; 
        $query.= " VALUES ";
        $query.= " ( :pro_nome, :pro_categoria, :pro_ativo, :pro_cli, :pro_cli_nome  :pro_valor,"; 
        ...
        ':pro_cli_nome'=> $this->getPro_cli_nome(),  
    ...
    function getPro_cli_nome(){
        return $this->pro_cli_nome;
    }
    ...
    function setPro_cli_nome($pro_cli_nome) {
        $this->pro_cli_nome = $pro_cli_nome;
    }
