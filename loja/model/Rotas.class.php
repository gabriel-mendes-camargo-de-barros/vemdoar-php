...
Class Rotas{
	...
	static function pag_ProdutosADM(){
		return self::get_SiteHOME() .'/adm_produtos';
	}

	static function pag_ProdutosNovoADM(){
		return self::get_SiteHOME() .'/adm_produtos_novo';
	}

	static function pag_ProdutosEditarADM(){
		return self::get_SiteHOME() .'/adm_produtos_editar';
	}

	static function pag_ProdutosDeletarADM(){
		return self::get_SiteHOME() .'/adm_produtos_deletar';
	}

	static function pag_ProdutosImgADM(){
		return self::get_SiteHOME() .'/adm_produtos_img';
	}
