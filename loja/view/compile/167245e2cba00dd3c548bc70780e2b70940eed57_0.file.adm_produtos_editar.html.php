<?php
/* Smarty version 3.1.36, created on 2020-10-07 09:07:48
  from 'C:\xampp\htdocs\loja\view\adm_produtos_editar.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5f7daf94662066_50002256',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '167245e2cba00dd3c548bc70780e2b70940eed57' => 
    array (
      0 => 'C:\\xampp\\htdocs\\loja\\view\\adm_produtos_editar.html',
      1 => 1602032935,
      2 => 'file',
    ),
  ),
...
function content_5f7daf94662066_50002256 (Smarty_Internal_Template $_smarty_tpl) {
?><div style="padding: 5%;>
    <?php echo '<script'; ?>
 src=" <?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/tema/js/tinymce/tinymce.min.js">
    <?php echo '</script'; ?>
>
        ...
        <form name="frm_produto" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="pro_nome" id="pro_nome" class="form-control" required
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_nome'];?>
">
...
">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="pro_valor" id="pro_valor" class="form-control" required
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_valor'];?>
">
                <br>
            </div>
            ...
            <!-- <div class="col-md-2">
                ...
                <input type="text" name="pro_estoque" id="pro_estoque" class="form-control" required
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_estoque'];?>
">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="pro_peso" id="pro_peso" class="form-control" required
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_peso'];?>
">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="pro_altura" id="pro_altura" class="form-control" required
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_altura'];?>
">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="pro_largura" id="pro_largura" class="form-control" required
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_largura'];?>
">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="pro_comprimento" id="pro_comprimento" class="form-control" required
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_comprimento'];?>
">
    ...
    <div class="col-md-4">
            ...
            <!-- <div class="col-md-12">
                ...
                <input type="text" readonly name="pro_slug" id="pro_slug" class="form-control"
                    value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_slug'];?>
">
...
">
    ...
    <section class="row">
        ...
        <div class="col-md-4 text-right">
            ...
            <br>
            <button class="btn btn-danger " name="btn_apagar" data-toggle="collapse" data-target="#btnapagar"><i
                    class="glyphicon glyphicon-remove"></i> Apagar Produto</button>
